...
window.BlockrainThemes = {
  'custom': {
    ...
    complexBlocks: {
      line:     ['../../static/img/assets/blocks/custom/line.png'],
      square:   ['../../static/img/assets/blocks/custom/square.png'],
      arrow:    ['../../static/img/assets/blocks/custom/arrow.png'],
      rightHook:['../../static/img/assets/blocks/custom/rightHook.png'],
      leftHook: ['../../static/img/assets/blocks/custom/leftHook.png'],
      rightZag: ['../../static/img/assets/blocks/custom/rightZag.png'],
      leftZag:  ['../../static/img/assets/blocks/custom/leftZag.png']
    }
  },
  'candy': {
    background: '#040304',
